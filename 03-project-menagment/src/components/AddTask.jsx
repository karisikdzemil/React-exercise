    ...
    <div className="min-h-4/5  m-auto mt-20 p-10 flex flex-col justify-center items-center gap-5">
      <div className="w-[100%] h-[40%]  border-b-4 pb-16">
        <button
          ...
          className="text-gray-800 font-medium hover:bg-gray-500 px-4 py-2 rounded-md float-right"
        >
          Delete
        </button>
        ...
        <ul className="min-30%">
          {tasks.map((el, i) => (
            <li
              ...
              className=" bg-gray-300 w-3/4 p-2 flex flex-row justify-between items-center"
            >
              <span>{el}</span>{" "}
