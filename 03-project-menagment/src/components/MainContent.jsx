...
export default function MainContent(){
    ...
    return(
        <section className="w-[60%] h-[90vh] mt-[10vh] bg-blue-400 float-left ml-10">
            <div className="w-2/3 h-2/3 bg-red-300 m-auto mt-20 p-10 flex flex-col justify-center items-center gap-5">
